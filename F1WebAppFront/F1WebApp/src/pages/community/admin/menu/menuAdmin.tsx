        ...
        <CommunityAdminMainContainer>
            <div className="actual-menu-admin">
                <div className="sub-cards-admin">
                    <Link to="/admin/users" className="sub-card-admin hover:scale-105 transition-transform duration-300 shadow-lg">
                        <h2>👤Users👤</h2>
                        <p>Update/Delete users or give 🏆Points🏆</p>
                    </Link>
                    <Link to="/admin/news" className="sub-card-admin hover:scale-105 transition-transform duration-300 shadow-lg">
                        <h2>📰 News 📰</h2>
                        <p>Delete news</p>
                    </Link>
                    <Link to="/admin/forum" className="sub-card-admin hover:scale-105 transition-transform duration-300 shadow-lg">
                        <h2>💬 Forum</h2>
                        <p>Delete Forum Threads</p>
                    </Link>
                    <Link to="/votings" className="sub-card-admin hover:scale-105 transition-transform duration-300 shadow-lg">
                        <h2>Votings</h2>
                        <p>Create, delete, give puntuations from votings</p>
                    </Link>
                    <Link to="/admin/points" className="sub-card-admin hover:scale-105 transition-transform duration-300 shadow-lg">
