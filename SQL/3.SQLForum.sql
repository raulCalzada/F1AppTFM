...
('Technical Innovations: Which Team Surprised You the Most?', 'Many teams brought experimental parts this year. Which innovation do you think gave the biggest advantage?', 7),
('Is it Time for a Sprint Race Format Change?', 'Some fans love it, some hate it. What are your thoughts on changing the sprint format for next year?', 7),
('Will 2025 Be Hamilton''s Last Season?', 'Speculation is growing around Hamilton''s future. Do you think he''ll retire after this season?', 8),
('Can Audi Make a Competitive Entry in 2026?', 'With Audi preparing to join the grid, how likely is it that they''ll compete at the front right away?', 9),
('Is the Budget Cap Really Leveling the Field?', 'We''re two years into the cost cap era. Are we seeing more competitiveness or the same dominance by top teams?', 3),
('What''s the Most Underrated Circuit on the Calendar?', 'Everyone talks about Monaco and Spa, but which circuit do you think doesn''t get the recognition it deserves?', 3),
('Should F1 Consider a Team Salary Cap?', 'Driver salaries are excluded from the cost cap. Should the FIA consider regulating that too?', 5);
...
('Bearman really impressed in tough conditions. Not easy to adapt that quickly.', 5, 5),
('Maloney showed great racecraft. He deserves a seat next year.', 4, 5),
('RB’s new rear diffuser surprised everyone. Great idea to break the dirty air cycle.', 5, 6),
('Aston Martin''s rear wing tests looked promising. Could be a big change next year.', 6, 6),
('Sprint races feel rushed. Maybe a reverse grid could spice things up?', 6, 7),
('They need to find a better way to balance risk and reward in sprints.', 5, 7),
...
('I love Suzuka, but I feel like Baku is the most underrated. Always chaotic and fun.', 4, 11),
('Zandvoort has a great atmosphere, and the banking is so unique.', 3, 11),
('Salaries are part of team power. Capping them could make driver moves more strategic.', 4, 12),
('That might scare away big names, though.', 3, 12);
GO
